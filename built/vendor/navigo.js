...
function findMatchedRoutes(url) {
    ...
    return routes.map(function (route) {
        var _replaceDynamicURLPar = replaceDynamicURLParts(clean(route.route)), regexp = _replaceDynamicURLPar.regexp, paramNames = _replaceDynamicURLPar.paramNames;
...
Navigo.prototype = {
    ...
    _listen: function _listen() {
        ...
        if (this._usePushState) {
            ...
            var cached = this._cLoc(), current = void 0, _check = void 0;
