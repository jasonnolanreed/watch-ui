...
export class DeviationGraph extends GWBWElement {
    ...
    render() {
        try {
            ...
            if (this.measuresData && this.measuresData.length > 1 &&
    ...
    initChart() {
        ...
        measuresData.forEach(thisMeasure => {
            ...
            if (!fastestPoint || fastestPoint < point.y) {
                fastestPoint = point.y;
            }
            if (!slowestPoint || slowestPoint > point.y) {
                slowestPoint = point.y;
            }
        });
        ...
        function getTooltip(activePoint) {
            ...
            if (point.dataset.label.toLowerCase() === `actual time`) {
                return;
            }
